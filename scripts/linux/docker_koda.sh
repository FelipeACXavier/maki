...
#   bash \
#   -ic \
#   "source /opt/ros/humble/setup.bash && source install/setup.bash && ros2 launch koda_ros koda.launch.py"
...
docker run \
  ...
  -v /home/felaze/Documents/PhD/Programs/maki/build/linux/debug/app/generation/PickAndPlace/ros:/home/felaze/ros2_ws/src/koda_ros:rw \
  -w /home/felaze/ros2_ws \
  ros2:v1.0.0 \
