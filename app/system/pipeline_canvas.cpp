...
PipelineCanvas::PipelineCanvas(std::shared_ptr<FlowSaveInfo> storage, std::shared_ptr<EdgeRouter> router, QObject* parent)
    : BehaviourCanvas(new Flow(storage->getname(), storage), router, parent)
{
}
