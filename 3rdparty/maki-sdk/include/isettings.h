...
public:
  ...
  {
    return getKey() == s.getKey() && getLabel() == s.getLabel() && getDescription() == s.getDescription() && getValue() == s.getValue() &&
           getDefaultValue() == s.getDefaultValue() && getType() == s.getType() && getMetadata() == s.getMetadata();
  }
...
public:
  ...
  virtual VoidResult registerSettings(const QString& id, const maki::PluginVersion version, const QString& iconPath,
