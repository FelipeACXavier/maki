...
PlatformIOCopySources::PlatformIOCopySources(maki::PlatformIOPlugin* generator)
    : mGenerator(generator)
{
}

QString PlatformIOCopySources::id() const
{
  return "platformio.copy_sources";
}

QString PlatformIOCopySources::displayName() const
{
  return "Copy Sources to PlatformIO Project";
}

QStringList PlatformIOCopySources::consumes() const
{
  return {"cpp", "platformio-project"};
}

QStringList PlatformIOCopySources::produces() const
{
